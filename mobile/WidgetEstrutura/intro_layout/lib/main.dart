    ...
    if(formKey.currentState!.validate()){
      if (_aceitarTermos) {
        showDialog(context: context, builder: (context)=>AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: [
                ...
                Text("Interesses: ${_interesses.join(", ")}"), //exibir os interesses selecionados
                Text("Cidade: $_cidade"),
              ],
          ...
          actions: [
            ElevatedButton(
              onPressed: () => Navigator.pop(context), //volta para a tela anterior(home)
              child: Text("OK!")),
              //limpar formulário
              setState(() {
                _nome = "";
                ...
                formKey.currentState!.reset(); //limpa os campos do formulário
              })
            )
          ]
        )); 
