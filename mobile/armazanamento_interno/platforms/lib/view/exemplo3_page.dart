...
List<String> _tarefas =[]; // armazenas as tarefas
...
_tarefas = _prefs.getStringList("tarefas+$nome") ??[];
 ...
 //salvar dados no shared  void _savePreferences() async {
 _prefs = await SharedPreferences.getInstance();
   nome = _prefs.getString("nome") ?? ""; //salvar preferencias
